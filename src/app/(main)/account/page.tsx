        ...
        <div className="max-w-2xl mx-auto">
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription>
                We couldn't load the guest account details. Please try again
                later.
              </CardDescription>
            </CardHeader>
          </Card>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Tabs defaultValue="orders" className="w-full">
          <TabsList className="w-full flex overflow-x-auto">
            <TabsTrigger value="orders" className="flex-1 min-w-max">
              <ShoppingBag className="mr-2 h-4 w-4" />
              Your Orders
            </TabsTrigger>
            <TabsTrigger value="security" className="flex-1 min-w-max">
              <User className="mr-2 h-4 w-4" />
              Login & Security
            </TabsTrigger>
            <TabsTrigger value="addresses" className="flex-1 min-w-max">
