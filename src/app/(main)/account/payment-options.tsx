      ...
      <CardContent>
        {methods.length > 0 ? (
                        ...
                        <div className="flex items-center gap-4">
                         ...
                         <AlertDialog>
                            ...
                            <AlertDialogContent>
                                ...
                                <AlertDialogDescription>
                                    This will permanently remove your saved card ending in {method.last4}.
                                </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                <AlertDialogCancel>Cancel</AlertDialogCancel>
                                <AlertDialogAction onClick={() => handleRemove(method.id)}>Remove Card</AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
                        </AlertDialog>
                    </div>
            ...
            <div className="text-center py-16 border rounded-lg">
                ...
                <h3 className="mt-4 text-lg font-semibold">No Saved Payment Methods</h3>
                <p className="mt-1 text-sm text-muted-foreground">
                    You can save your payment details during checkout for a faster experience next time.
                </p>
