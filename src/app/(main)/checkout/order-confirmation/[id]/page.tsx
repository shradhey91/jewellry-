...
export default function OrderConfirmationPage() {
  ...
  const subtotal = order.items.reduce(
    (acc, item) => acc + item.price_snapshot.total * item.quantity,
    0,
  );
        ...
        <Card className="shadow-2xl">
          <CardHeader className="text-center bg-background rounded-t-lg p-8">
            ...
            <CardTitle className="text-3xl font-bold font-headline">
              Thank you for your order, {order.shippingAddress.name}!
            </CardTitle>
            <p className="text-muted-foreground max-w-xl mx-auto">
              Your order has been placed successfully. A confirmation email has
              been sent to your inbox with the details of your purchase.
            </p>
          </CardHeader>
                    ...
                    <div className="ml-4 flex flex-1 flex-col">
                      <div>
                        <div className="flex justify-between text-base font-medium text-foreground">
                          ...
                          <p className="ml-4">
                            {formatCurrency(
                              item.price_snapshot.total * item.quantity,
                            )}
                          </p>
                        </div>
