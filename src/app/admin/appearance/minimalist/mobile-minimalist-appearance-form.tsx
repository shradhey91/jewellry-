...
import {
  saveMobileMinimalistHomepageAction,
  MinimalistFormState,
} from "./actions";
...
export function MobileMinimalistAppearanceForm({
  content,
  categories,
  ...
  const [exchangeImage, setExchangeImage] = useState(content.assurance_and_exchange.exchange.image);
  const [giftImage, setGiftImage] = useState(content.gifts_and_experiences.gift.image);
          ...
          <AccordionItem value="assurance_and_exchange">
            <Card>
              ...
              <AccordionContent className="px-6 pb-6 space-y-4">
                ...
                />
               <ImageUpload label="Exchange Image URL" value={exchangeImage} onChange={setExchangeImage} />
                <InputField
          ...
          <AccordionItem value="gifts_and_experiences">
            <Card>
              ...
              <AccordionContent className="px-6 pb-6 space-y-4">
                ...
                />
               <ImageUpload label="Gift Image URL" value={giftImage} onChange={setGiftImage} />
                <InputField
                  name="gift-cta-label"
