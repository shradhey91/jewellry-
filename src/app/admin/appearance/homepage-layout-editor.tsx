    ...
    <form action={formAction}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage the sections on your {isMobile ? "mobile " : ""}homepage.
            Drag to reorder.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-2">
          {layout.map((section) => (
            <div
              key={section.id}
              className="flex items-center justify-between rounded-lg border p-4 bg-muted/40"
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleVisibilityChange(section.id, checked)
                  }
                />
              </div>
            </div>
