...
const allPermissions: { id: Permission; label: string; group: string }[] = [
    // Dashboard & Reports
    { id: 'dashboard:view', label: 'View Dashboard', group: 'Dashboard & Reports' },
    { id: 'reports:view', label: 'View Sales Reports', group: 'Dashboard & Reports' },
    // Store Management
    { id: 'orders:view', label: 'View Orders', group: 'Store Management' },
    { id: 'orders:edit', label: 'Update Order Status', group: 'Store Management' },
    { id: 'customers:view', label: 'View Customers', group: 'Store Management' },
    { id: 'customers:edit', label: 'Edit & Ban Customers', group: 'Store Management' },
    { id: 'discounts:manage', label: 'Manage Discounts', group: 'Store Management' },
    // Catalog
    ...
    { id: 'blog:create', label: 'Create Blog Posts', group: 'Content & Appearance' },
    { id: 'blog:edit', label: 'Edit Blog Posts', group: 'Content & Appearance' },
    { id: 'blog:delete', label: 'Delete Blog Posts', group: 'Content & Appearance' },
    { id: 'media:manage', label: 'Manage Media Library', group: 'Content & Appearance' },
    { id: 'pages:manage', label: 'Manage Static Pages', group: 'Content & Appearance' },
    { id: 'appearance:manage', label: 'Manage Homepage Content & Themes', group: 'Content & Appearance' },
    { id: 'menus:manage', label: 'Manage Navigation Menus', group: 'Content & Appearance' },
    // Settings
    { id: 'pricing:manage', label: 'Manage Pricing & Purities', group: 'Settings' },
    { id: 'tax:manage', label: 'Manage Tax Classes', group: 'Settings' },
    { id: 'shipping:manage', label: 'Manage Shipping', group: 'Settings' },
    { id: 'settings:manage', label: 'Manage General & Payment Settings', group: 'Settings' },
    // Administration
    { id: 'users:manage', label: 'Manage Admins & Roles', group: 'Administration' },
];
...
function SubmitButton() {
    ...
    return <Button type="submit" disabled={pending}>{pending ? <><Loader2 className="mr-2 h-4 w-4 animate-spin"/> Saving...</> : "Save All Changes"}</Button>
}
