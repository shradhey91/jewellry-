        ...
        <Collapsible defaultOpen={isProductsActive}>
            ...
            <CollapsibleContent asChild>
                <SidebarMenuSub>
                    ...
                    <SidebarMenuSubButton asChild isActive={pathname === '/admin/products/new'}>
                        <Link href="/admin/products/new">Add New</Link>
                    </SidebarMenuSubButton>
                    <SidebarMenuSubButton asChild isActive={pathname === '/admin/products/bulk-upload'}>
                        <Link href="/admin/products/bulk-upload">Bulk Upload</Link>
                    </SidebarMenuSubButton>
                    <SidebarMenuSubButton asChild isActive={pathname === '/admin/products/themes'}>
