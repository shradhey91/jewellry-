        ...
        <Collapsible defaultOpen={isSettingsActive}>
            ...
            <CollapsibleContent asChild>
                <SidebarMenuSub>
                    ...
                    <SidebarMenuSubButton asChild isActive={pathname === '/admin/settings/payment'}>
                        <Link href="/admin/settings/payment">Payment Gateways</Link>
                    </SidebarMenuSubButton>
                    <SidebarMenuSubButton asChild isActive={pathname === '/admin/settings/email'}>
                        <Link href="/admin/settings/email">Email</Link>
                    </SidebarMenuSubButton>
                    <SidebarMenuSubButton asChild isActive={pathname === '/admin/settings/gifting'}>
