...
const menuItemSchema = z.object({
  ...
  link: z.string(), // Allow '#' or relative paths, don't require .url()
...
export async function saveMenuAction(
  ...
  try {
    ...
    if (!validatedFields.success) {
      console.error("Menu validation failed:", validatedFields.error.flatten().fieldErrors);
      return {
